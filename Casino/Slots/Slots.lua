...
if (e.message:findi("hail")) then
	e.other:Message(315,"Hail!  I may not look like it, but I am a [slot] machine.  If you would like to [play], please give yourself a balance of at least 5 platinum pieces with the Casino Banker!");
end
